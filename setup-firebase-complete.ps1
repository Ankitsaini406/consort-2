# PowerShell script to set up both Firebase Admin SDK and Client SDK configurations
# This script will create/update both .env and .env.local files

# Create the Firebase service account key content
$serviceAccountKey = @{
    type = "service_account"
    project_id = "consortdigital-327d9"
    private_key_id = "c3b4dc966046c58ef431fd05caa86ea6a4cce0f5"
    ...
    client_email = "firebase-adminsdk-fbsvc@consortdigital-327d9.iam.gserviceaccount.com"
    client_id = "106163541376917538961"
    auth_uri = "https://accounts.google.com/o/oauth2/auth"
    token_uri = "https://oauth2.googleapis.com/token"
    auth_provider_x509_cert_url = "https://www.googleapis.com/oauth2/v1/certs"
    client_x509_cert_url = "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40consortdigital-327d9.iam.gserviceaccount.com"
    universe_domain = "googleapis.com"
}

# Convert the service account object to JSON
$serviceAccountJson = $serviceAccountKey | ConvertTo-Json -Compress
...
# Write the content to .env.local and .env
[System.IO.File]::WriteAllText(".env.local", $envLocalContent, $utf8NoBom)
[System.IO.File]::WriteAllText(".env", $envContent, $utf8NoBom)

Write-Host "✅ Created .env.local and .env files with Firebase configuration" -ForegroundColor Green
...
$env:FIREBASE_SERVICE_ACCOUNT_KEY = $serviceAccountJson
$env:FIREBASE_CLIENT_EMAIL = "firebase-adminsdk-fbsvc@consortdigital-327d9.iam.gserviceaccount.com"
