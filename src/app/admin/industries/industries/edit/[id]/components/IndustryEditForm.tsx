    ...
    try {
        await withRateLimit(clientId, 'formSubmission', async () => {
            ...
            const updateData: Partial<IndustryFormData> = {
                ...
                // Preserve existing globalTags if not modified
                globalTags: data.globalTags || originalData.globalTags || [],
                // Preserve metadata
                slug: originalData.slug
            };

            console.log(`[${context}] Updating industry:`, { documentId, updateData });
            ...
            console.log(`[${context}] Edit successful:`, { docId: documentId });
                ...
                console.error(`[${context}] Database update error:`, error);
                throw new Error('Failed to update industry in database');
            }
        });
...
export const IndustryEditForm: React.FC<IndustryEditFormProps> = ({ documentId }) => {
    ...
    const config = {
        ...industryEditFormConfig(clientTags),
