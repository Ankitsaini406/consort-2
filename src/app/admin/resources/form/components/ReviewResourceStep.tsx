...
export const ReviewResourceStep: React.FC<BaseReviewStepProps<ResourceFormData>> = ({
    formData,
    className,
}) => {
    ...
    return (
        <ReviewStepContainer className={className}>
            <SummaryCard title="Resource Details" useGrid={true}>
                <GridFieldDisplay
                ...
                <GridFieldDisplay
                    label="Headline"
                    value={headline as React.ReactNode}
                    type="textarea"
                    colSpan={1} />
                <GridFieldDisplay
                    label="Global Tags"
                    value={globalTags as React.ReactNode}
                    type="tags"
                    colSpan={1} />
                <GridFieldDisplay
                    label="Client Companies"
                    value={clientCompanies as React.ReactNode}
                    type="tags"
                    colSpan={1} />
            </SummaryCard>
