...
/*
 * Documentation:
 * Button2 — https://app.subframe.com/bbaea32c4115/library?component=Button2_2951a212-7b0d-46e1-8732-51fb54b5093c
 */
...
const Button2Root = React.forwardRef<HTMLElement, Button2RootProps>(
    ...
    return (
      <button
        className={SubframeUtils.twClassNames(
          "group/2951a212 flex h-8 cursor-pointer items-center justify-center gap-2 rounded-lg border-none bg-brand-primary px-4 hover:bg-brand-500 active:bg-brand-600 disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
          {
            ...
            "bg-consort-red hover:bg-error-500 active:bg-error-600":
      ...
      >
        {icon ? (
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-body font-body text-white group-disabled/2951a212:text-neutral-400",
              {
                hidden: loading,
        ...
        >
          <SubframeCore.Loader
            className={SubframeUtils.twClassNames(
              "text-caption font-caption text-white group-disabled/2951a212:text-neutral-400",
              {
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-body font-body text-white group-disabled/2951a212:text-neutral-400",
              {
                hidden: loading,
                "font-['Roboto'] text-[14px] font-[400] leading-[20px] tracking-normal":
                  size === "small",
