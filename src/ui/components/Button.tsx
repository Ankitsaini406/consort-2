...
/*
 * Documentation:
 * Button — https://app.subframe.com/bbaea32c4115/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
    ...
    return (
      <button
        className={SubframeUtils.twClassNames(
          "group/3b777358 flex h-8 cursor-pointer items-center justify-center gap-2 border-none rounded-lg bg-brand-primary px-4 hover:bg-brand-500 active:bg-brand-600 disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
          {
      ...
      >
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-white text-body font-body group-disabled/3b777358:text-neutral-400",
              {
                hidden: loading,
        ...
        {iconRight ? (
          <IconWrapper
            className={SubframeUtils.twClassNames(
              "text-white text-caption font-caption group-disabled/3b777358:text-neutral-400",
              {
                "text-body font-body": size === "small",
                "text-heading-3 font-heading-3": size === "large",
                "text-white": variant === "inverse",
