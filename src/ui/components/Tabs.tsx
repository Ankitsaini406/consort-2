...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/bbaea32c4115/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        "group/d5612535 flex h-10 cursor-pointer items-center justify-center gap-2 border-b border-solid border-neutral-border py-0.5 px-4",
        {
          "border-b-2 border-solid border-consort-red px-2.5 pt-0.5 pb-px hover:border-b-2 hover:border-solid hover:border-consort-red":
            active,
        },
        className
      )}
    ...
    >
      ...
      {children ? (
        <span
          className={SubframeUtils.twClassNames(
            "text-subtext-color text-body font-body group-hover/d5612535:text-consort-red",
            {
              "text-neutral-400 group-hover/d5612535:text-neutral-400":
                disabled,
              "text-consort-red group-hover/d5612535:text-consort-red": active,
            }
          )}
        >
          {children}
