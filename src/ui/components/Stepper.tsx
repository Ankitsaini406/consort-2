...
/*
 * Documentation:
 * Stepper — https://app.subframe.com/bbaea32c4115/library?component=Stepper_3c5d47dc-1b1a-45d9-b244-18422d7bfb56
 */
      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            ...
            {
              "bg-success-100": variant === "active",
              "bg-warning-100": variant === "completed",
            }
          )}
        >
          {stepNumber ? (
