...
import { IconWrapper, Loader, FeatherPlus } from "@subframe/core";
    ...
    return (
      <button
        className={SubframeUtils.twClassNames(
          "group/af9405b1 flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm border-none bg-transparent hover:bg-neutral-100 active:bg-neutral-50 disabled:cursor-default disabled:bg-neutral-100",
          {
            "h-6 w-6": size === "small",
        ...
        {icon ? (
          <IconWrapper
            className={SubframeUtils.twClassNames(
              ...
              {
                hidden: loading,
                "text-body-lg font-body": size === "small",
                "text-xl font-body": size === "medium",
                "text-2xl font-body": size === "large",
